...
int main( int argc, char* argv[] ) {
   ...
   std::string submitDir = "output2016";
   ...
   SH::SampleHandler sh;
   SH::scanRucio (sh, "data16_13TeV.period%.physics_Main.PhysCont.DAOD_STDM3.grp15_v11_p3372_p3388_p3402/");
   ...
   driver.options()->setString("nc_outputSampleName", "user.bili.Data16.v1p3");
