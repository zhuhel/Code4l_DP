...
int main( int argc, char* argv[] ) {
   ...
   SH::scanRucio (sh, "data17_13TeV.periodB.physics_Main.PhysCont.DAOD_STDM3.grp15_v11_p3372_p3388_p3402/");
   ...
   driver.options()->setString("nc_outputSampleName", "user.bili.Data17_periodB.v1p3");
