...
int main( int argc, char* argv[] ) {
   ...
   std::string submitDir = "output2015";
   ...
   SH::SampleHandler sh;
   SH::scanRucio (sh, "data15_13TeV.period%.physics_Main.PhysCont.DAOD_STDM3.grp15_v11_p3372_p3388_p3402/");
   ...
   driver.options()->setString("nc_outputSampleName", "user.bili.Data15.v1p3");
